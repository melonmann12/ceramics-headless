...
const images = [
  ...
  'https://lh3.googleusercontent.com/aida-public/AB6AXuADadcCbbdG-tQl8fF02Tu2bHYZF4M9yAt8TMPIb09QTaSVqaanHu4PXOnTqnFhWr1fmjg9Zaw7j6zeV5WGLfzro8qxVQyHeD3wcVJCHLIVO0cuIgS3uGSZp7g3c4PWuLagvVuo1fc-6wmo_R4SpdLI2NI-f1IPHci53SO1FJBkpAXkFZvlwn8vSZUzdsn6qt7NLUqe5nOP4ddmHoEPa8re9lxsSOUdmSR7yJC6XSWULiqkj38uD5Ll',
      ...
      <div className="social-gallery hide-scrollbar">
        {images.map((img, idx) => (
          <div key={idx} className="social-item">
            <img src={img} alt={`Social gallery image ${idx + 1}`} loading="lazy" />
          </div>
        ))}
      </div>
      
      <div className="social-cta">
        <button className="pill-btn">@OURA_CERAMICS</button>
      </div>
    </section>
  );
}
